...
module Pod
  class TemplateConfigurator
    ...
    def ensure_carthage_compatibility
      FileUtils.ln_s('Example/Pods/Pods.xcodeproj', 'Pods.xcodeproj')
    end
    ...
    def clean_template_files
      ["./**/.gitkeep", "configure", "_CONFIGURE.rb", "templates", "setup", "CODE_OF_CONDUCT.md"].each do |asset|
        `rm -rf #{asset}`
      end
    end

    def replace_variables_in_files
      file_names = ['POD_LICENSE', 'NAME.podspec', '.travis.yml', podfile_path]
